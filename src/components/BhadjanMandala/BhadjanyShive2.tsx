...
const BhadjanyShive2 = () => {
  return (
    <div>
      ...
      <h2 className="mb-2 mt-5 md:mt-7 lg:mt-10 text-xl md:text-2xl w-full">
        10. ДЖАЯ ШИВА ШАНКАРА БОМ БОМ ХАРЕ ХАРЕ
      </h2>
      <p className="font-medium">
      ...
      <h2 className="mb-2 mt-5 md:mt-7 lg:mt-10 text-xl md:text-2xl w-full">
        12.ХАРА ХАРА ШАНКАРА ПАРАМЕШВАРА
      </h2>
      <p className="font-medium">
