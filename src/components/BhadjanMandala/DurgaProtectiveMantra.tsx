...
const DurgaProtectiveMantra = () => {
  return (
    <div className='w-full mt-5 md:mt-7 lg:mt-10 flex justify-center'>
      <MyAccordion id='DurgaProtectiveMantra' title='Защитная мантра Дурги' big className='max-w-xl'>
        <div className="mt-5 lg:mt-10 w-full flex flex-col gap-5 font-light">
          <div className="w-full flex flex-wrap items-center justify-center py-5">
            <audio
              controls
              controlsList="nodownload"
              src="/sounds/BhadjanMandala/DurgaProtectiveMantra.mp3"
              className="w-full"
            ></audio>
          </div>
...
export default DurgaProtectiveMantra