        ...
        <div className="w-full flex flex-col gap-5 font-light">
          ...
          <div className="w-full flex flex-wrap items-center justify-center py-5">
            <audio
              ...
              src="/sounds/Djaya-kara/Guru.mp3"
              className="w-full"
            ></audio>
          </div>
          ...
          <div className='w-4xl'>
            ...
            Шива Прабхакара сидха-йоги шри Гуру Брахмананда авадхута ки – джей <br />
            гуру шишья парампара ки – джей <br /><br />
