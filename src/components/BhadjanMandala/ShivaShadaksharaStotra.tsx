        ...
        <div className="mt-5 lg:mt-10 w-full flex flex-col gap-5">
          <div className="w-full flex flex-wrap items-center justify-center py-5">
            <audio
              ...
              src="/sounds/BhadjanMandala/ShivaShadaksharaStotra.mp3"
              className="w-full"
            ></audio>
          </div>
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Вечное наше поклонение слогу «ом», на котором йогины в
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            ...
            Трансцендентному Я, Великому богу, разрушителю
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Всеблагому и всемогущему Господу Вселенной, воплощенному в
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Обнимающему Шакти левой рукой, восседающему на быке и
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            ...
            составленную из шести священных слогов «Ом на-мах Шивайя»,
...
export default ShivaShadaksharaStotra