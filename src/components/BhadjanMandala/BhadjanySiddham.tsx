      ...
      <MyAccordion id='BhadjanySiddham' title='Бхаджаны сиддхам' big className='max-w-xl'>
        <div className="mt-5 lg:mt-10 w-full flex flex-col gap-5">
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            ...
            сущности Абсолюта! Я простираюсь перед Бхагаваном
            Рамалингой, изначальным Гуру, величайшим воплощением
            Божественной Славы!
          </p>
...
export default BhadjanySiddham