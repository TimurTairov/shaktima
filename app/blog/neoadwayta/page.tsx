  ...
  return (
    <Container >
      ...
      <div className=" mx-2 mt-5">
        ...
        <p className="mt-5">Итак, если вы знаете это и помните эти наставления, вы сможете избежать эти нигилистические ловушки.</p>
        <p className="mt-5">Из сатсанга Шри Гуру Свами Вишнудевананда Гири Махараджа</p>
      </div>
    </Container>
  )
}
