    ...
    <Container className="font-light text-gray-700 dark:text-gray-300">
      ...
      <div className="mx-2 mt-5 flex flex-col gap-3 indent-5 md:indent-10">
        ...
        <div className="mt-10 lg:mt-20">
          <h5 className="font-semibold text-xs lg:text-lg text-center lg:ml-2 mb-2">Отчетный репортаж Адитьи о поездке в Москву на день Индии </h5>
          <div className='lg:mx-20 xl:mx-40'>
            <Suspense fallback={<p>Загрузка ...</p>}>
              <iframe src="https://rutube.ru/play/embed/e4eb1639d07a43ec99845446c1748ffc?skinColor=e53935" frameBorder="0" allow="clipboard-write; autoplay" allowFullScreen className='w-full lg:h-100 xl:h-120 2xl:h-160 rounded-md'></iframe>
            </Suspense>
          </div>
        </div>
      </div>
      ...
      <div className="mt-20">
        ...
        <div className="my-10">
          <h5 className="font-semibold text-lg text-center">Часть 1. Общие фотографии</h5>
          <div className="flex justify-center items-center w-full">
            <ImageGallery items={indiaday__2024} {...settings} />
          </div>
        </div>
        <div className="my-10">
          <h5 className="font-semibold text-lg text-center">Часть 2. Наш шатер</h5>
          <div className="flex justify-center items-center w-full">
            <ImageGallery items={indiaday_shater_2024} {...settings} />
          </div>
        </div>
        <div className="my-10">
          <h5 className="font-semibold text-lg text-center">Часть 3. Практики</h5>
          <div className="flex justify-center items-center w-full">
            <ImageGallery items={indiaday_praktiki_2024} {...settings} />
          </div>
        </div>
        <div className="my-10">
          <h5 className="font-semibold text-lg text-center">Часть 4. Детская Мандала</h5>
          <div className="flex justify-center items-center w-full">
