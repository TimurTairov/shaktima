...
const page = () => {
  return (
    <Container>
      <div className="flex flex-wrap gap-5 lg:gap-0 py-10 font-light text-gray-700 dark:text-gray-300">
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="max-w-2xl h-80 lg:h-full mb-8 flex flex-col justify-around">
            <h1 className="w-full text-center lg:text-start text-3xl font-bold leading-snug tracking-tight text-red-500 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight textColor">
              Йога марафон
            </h1>
            ...
            <div className="w-full flex flex-col items-center sm:flex-row">
              <a
                ...
                className="w-full px-8 py-4 text-lg font-medium text-center text-white dark:text-white bg-red-500 rounded-md "
              >
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <Image
            ...
            width="855"
            height="638"
            className={'object-cover w-full lg:w-auto lg:h-144 rounded-md'}
