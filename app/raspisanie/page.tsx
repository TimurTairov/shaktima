    ...
    <Container className="min-h-screen">
      ...
      <div className="w-full">
        <MyAccordion title='Хатха йога' className="w-full flex flex-col text-xs gap-1">
          ...
          <p>Для чего нужна хатха йога? <br />
        ...
        <div className="flex items-center">
          <MyAccordion title='Бхаджан Мандала' className="w-full flex flex-col text-xs">
            ...
            <p>
              В зависимости от дня недели выполняются разные практики:
              Понедельник — пуджа Шиве для постижения аскетичных садхан.
              Вторник — пуджа Даттатрее для познания недвойственного воззрения Адвайта Веданты.
              Среда — пуджа Вишну для поддержки со стороны Высших сил в относительном измерении.
              Четверг — пуджа Гуру для укрпеления связи с духовными Учителями.
              Пятница — пуджа Шакти для
            </p>
            <p>Что включает:<br />
              · Гуру йога с ОМ.<br />
              · Мантры Ганеше + Ганеша Арати.<br />
