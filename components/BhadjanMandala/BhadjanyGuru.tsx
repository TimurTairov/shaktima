    ...
    <div className='w-full mt-5 md:mt-7 lg:mt-10 flex justify-center'>
      <MyAccordion id='BhadjanyGuru' title='Бхаджаны Гуру' big className='max-w-xl'>
        <div className="mt-5 lg:mt-10 w-full flex flex-col gap-5">
          <a href='https://t.me/jkjlkjscksj/17/1031' target="_blank" rel="noreferrer" className="text-indigo-600 dark:text-indigo-300 text-xs sm:text-sm md:text-md lg:text-base">
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            ...
            Тому, кто осушает океан иллюзий и открывает
            действительное великолепие.
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Вечный, чистый, неописуемое Бытие, бесформенный,
            не имеющий недостатков, всезнающий, блаженный, осознающий.
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            ...
            Гуру – это великое Божество. Воистину, Гуру – это вся вселенная,
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Я выражаю почтение драгоценному Гуру!<br />
          ...
          <p className="font-bold">
            ...
            ГУРУ ВАРА ГУРУ ВАРА ГУРУ БАБА<br />
            ШАНТА СВАРУПА ГУРУ БАБА<br />
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Преданность Гуру, кто есть Брахма, преданность Гуру, кто есть
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Слава божественному Гуру, воплощению
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Я простираюсь перед Божественным Гуру! Я преклоняюсь и
            простираюсь перед изначальным Божественным Гуру!
            Слава, слава Тебе, воплощающему в своей форме саму Высшую
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            Слава Истинному Гуру, который есть сам Бхагаван! Изначальный
          ...
          <p className="font-bold">
            ...
            АДИНАТХА САТГУРУ ДЖАЯ ДЖАЯ<br />
            ОМ НАМАХ ШИВАЯ ОМ НАМАХ ШИВАЯ<br />
            ОМ НАМАХ ШИВАЯ ШИВАЯ НАМО ОМ<br />
            ОМ НАМО ГУРУ МА ОМ НАМО ГУРУ МА<br />
          ...
          <p className="text-balance max-w-screen-sm text-sm">
            ...
            Реальности! Гуру есть начало всего! Гуру есть
