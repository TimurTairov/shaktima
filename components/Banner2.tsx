    ...
    <div className="w-full flex flex-col gap-10 lg:gap-12 xl:gap-16 2xl:gap-20 text-gray-700 dark:text-gray-300">
      <div className="flex flex-col lg:flex-row gap-1 justify-between">
        ...
        <div className="w-full lg:w-5/12 flex flex-col justify-around text-lg gap-2">
          ...
          <p className="text-sm md:text-base lg:text-lg">ॐ Хатха йога</p>
          <p className="text-sm md:text-base lg:text-lg">ॐ Кундалини йога</p>
          <p className="text-sm md:text-base lg:text-lg">ॐ Шат-чакра-йога йога</p>
          <p className="text-sm md:text-base lg:text-lg">ॐ Йога сиддхов</p>
          <p className="text-sm md:text-base lg:text-lg">ॐ Мантра йога</p>
          <p className="text-sm md:text-base lg:text-lg">ॐ Джняна йога</p>
