    ...
    <Container className="flex flex-wrap justify-between">
      <div className="flex items-center justify-center w-full lg:w-5/12">
        <div className="h-full flex flex-col justify-around">
          <h1 className="w-full text-center lg:text-start text-3xl font-medium leading-snug tracking-tight text-red-500 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight">
            Бхаджан Мандала
          </h1>
          <p className="w-full text-center lg:text-start mt-5 text-lg leading-normal font-light text-balance text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            Откройтесь безусловной любви через интеграцию с бхаджанами и песнями
      ...
      <div className="flex items-center justify-center w-full lg:w-6/12 mt-5">
        <Image
          src={heroImg}
          width="855"
          height="638"
