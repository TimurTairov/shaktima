      ...
      <div
        ...
        <div>
          <div className="flex flex-col w-full mt-4">
            <h3 className="max-w-2xl mt-3 text-3xl font-semibold leading-snug tracking-tight textColor lg:leading-tight lg:text-4xl">
              {data.title}
            </h3>

            <div className="max-w-2xl py-4 text-sm sm:text-base md:text-lg leading-normal font-light text-gray-500 lg:text-xl xl:text-xl dark:text-gray-200">
              {data.desc}
            </div>
          </div>
