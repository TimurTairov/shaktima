    ...
    <div className="py-20">
      <Container className="flex flex-wrap">
        <div className="grid grid-cols-4 w-full lg:w-1/2">
          {altar.map((item) => (
            <Image src={item} alt="murti" />
          ))}
        </div>
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="w-full text-center text-3xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Бхаджан Мандала
            </h1>
            <p className="w-full text-center py-5 text-lg leading-normal text-gray-500  dark:text-gray-300">
              Призывание благословений Древа Прибежища
            </p>
            <div className="flex w-full flex-col md:px-20 lg:px-40 h-9">
