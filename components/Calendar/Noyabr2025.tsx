...
import yogaSeminar from '@/public/svg/yoga-asana2.svg'


const Noyabr2025 = () => {
  return (
    <div className="mt-5 lg:mt-10">
      <p className="text-lg lg:text-xl ">Ноябрь 2025</p>
      <div className="flex justify-center">
        <div className="w-full grid grid-cols-7 gap-1 rounded-md">
          ...
          <div className="grid-item">
            ...
            <div className="flex h-full flex-wrap justify-center items-center gap-1">
              <a href="/mdc-events/hatha-yoga-workshop-02-11-25">
                <Image src={yogaSeminar} alt="Семинар по хатха йоге в Москве" className="grid-meditation-mobile p-0.5" />
              </a>
            </div>
          </div>
      ...
      <div className="w-full flex flex-col md:flex-row flex-wrap gap-3">
        <div className="flex items-center">
          <Image src={yogaSeminar} alt="Дни Индии в Москве" className="grid-meditation-mobile p-0.5 mr-1" />
          <a href="/mdc-events/hatha-yoga-workshop-02-11-25">
            <p className="verySmallText md:text-xs">Семинар по хатха йоге.</p>
          </a>
        </div>
      </div>
