...
import lakshmi from '@/public/svg/lakshmi.svg'
import brahmananda from '@/public/img/brahmananda.webp'

const Mart2025 = () => {
  return (
    <div className="mt-5 lg:mt-10">
      <p className="text-lg lg:text-xl ">Март 2025</p>
      <div className="flex justify-center">
        <div className="w-full grid grid-cols-7 gap-1 rounded-md">
          ...
          <div className="grid-item">
            ...
            <div className="flex justify-center items-center">
              <a>
                <Image src={brahmananda} alt="Брахмананда Джаянти" className="grid-meditation-mobile" />
              </a>
            </div>
          </div>
          <div className="grid-item">
      ...
      <div className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 2xl:grid-cols-5 gap-1">
        ...
        <div className="w-full flex items-center">
          <Image src={lakshmi} alt="Махалакшми Джаянти" className="grid-meditation-mobile mr-1" />
          <a>
            <p className="verySmallText md:text-xs">Махалакшми Джаянти</p>
          </a>
        </div>
        <div className="w-full flex items-center">
          <Image src={brahmananda} alt="Брахмананда Джаянти" className="grid-meditation-mobile mr-1" />
          <a>
            <p className="verySmallText md:text-xs">Брахмананда Джаянти</p>
          </a>
        </div>
      </div>
